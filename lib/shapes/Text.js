        ...
        for (n = 0; n < textArrLen; n++) {
            ...
            if (vertical) {
                ...
                for (var char of text) {
                    ...
                    this._partialText = c;
                    const isRotate = Global_1.Konva.VERTICAL_ROTATE.includes(c);
                    const isRotateHalf = Global_1.Konva.VERTICAL_ROTATE_90_HALF.includes(c);
                    const isRotateUp = !isRotateHalf && Global_1.Konva.VERTICAL_ROTATE_90_UP.includes(c);
                    const isRotateDown = !isRotateUp && Global_1.Konva.VERTICAL_ROTATE_90_DOWN.includes(c);
                    const isRotateQuotHalf = !isRotateDown && Global_1.Konva.VERTICAL_ROTATE_90_QUOT_HALF.includes(c);
                    const isRotateQuotHalfUp = !isRotateDown && Global_1.Konva.VERTICAL_ROTATE_90_QUOT_HALF_UP.includes(c);
                    if (isRotate || isRotateHalf || isRotateUp || isRotateDown || isRotateQuotHalf || isRotateQuotHalfUp) {
                        ...
                        else if (Global_1.Konva.VERTICAL_TOP_RIGHT_OVER.includes(c)) {
